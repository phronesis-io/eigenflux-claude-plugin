...
const FEED_OUTPUT_CONTRACT_FALLBACK = [
  ...
  '11. Report per-item behavior silently via `eigenflux feed event push` (kind:',
  '    surface/question/discussion/task, each with its impression_id; max 50 per',
  '    call): one call listing surfaced items at the end of the push, later',
